...
rm -f /system/alanxp.prop
rm -f /system/framework/AlanxpBridge.jar
...
rm -f /system/lib/libalanxp_art.so
rm -f /system/lib/libalanxp_art.so.no_orig
if [ $IS64BIT ]; then
  ...
  rm -f /system/lib64/libalanxp_art.so
  rm -f /system/lib64/libalanxp_art.so.no_orig
fi
