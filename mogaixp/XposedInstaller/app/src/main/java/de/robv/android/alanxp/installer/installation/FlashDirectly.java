...
import de.robv.android.alanxp.installer.util.InstallZipUtil.ZipCheckResult;
import de.robv.android.alanxp.installer.util.RootUtil;

import static de.robv.android.alanxp.installer.util.InstallZipUtil.closeSilently;
import static de.robv.android.alanxp.installer.util.InstallZipUtil.triggerError;
import static de.robv.android.alanxp.installer.util.RootUtil.getShellPath;
